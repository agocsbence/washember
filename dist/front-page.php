...
<main class="" id="home-page-content">
    <div onclick="location.href = '<?php echo get_permalink(17); ?>';" id="lakossagi" class="circle">
        <p><strong>lakossági</strong></p>
        <p><strong><a href="tel:+36 20 266 3604">+36 20 266 3604</a></strong></p>
    </div>
    <div onclick="location.href = '<?php echo get_permalink(19); ?>';" id="uzleti" class="circle">
